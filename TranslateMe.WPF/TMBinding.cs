...
{
    /// <summary>
    /// This is a Translation dependant binding it recreate a standard binding and automatically update it when current language changed
    /// </summary>
    public class TMBinding : MarkupExtension
    {
        /// <summary>
        /// Default Constructor
        /// </summary>
        ...
        public TMBinding(PropertyPath path)
        {
            WeakEventManager<TM, TMLanguageChangedEventArgs>.AddHandler(TM.Instance, nameof(TM.Instance.CurrentLanguageChanged), CurrentLanguageChanged);
            Path = path;
        }
